...
int main() {
int* vals = new int[30]{100,60,120,50,80,30,20,40,50,10,20,40,30,40,70,120,50,20,40,40,100,60,120,50,80,30,20,40,50,10};
int* wts = new int[30]{20,10,30,40,10,60,20,10,50,70,10,30,40,20,10,20,10,30,20,30,20,10,30,40,10,60,20,10,50,70};
int capacity = 300;
int n = 30;
int sizeOfPop = 100;
...
std::cout<<"TIME ELAPSED: "<<std::chrono::duration_cast<std::chrono::microseconds>(endRecursion-beginRecursion).count()<<"[μs]"<<std::endl;

std::cout<<"----KNAPSACK DYNAMIC PROGRAMMING----"<<std::endl;
std::cout<<"RESULT: "<<resultDP<<std::endl;
std::cout<<"TIME ELAPSED: "<<std::chrono::duration_cast<std::chrono::microseconds>(endDP-beginDP).count()<<"[μs]"<<std::endl;
...
std::cout<<"TIME ELAPSED: "<<std::chrono::duration_cast<std::chrono::microseconds>(endGenetic-beginGenetic).count()<<"[μs]"<<std::endl;
return 0;
}
